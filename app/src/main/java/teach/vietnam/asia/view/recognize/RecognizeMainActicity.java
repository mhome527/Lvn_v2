...
public class RecognizeMainActicity extends BaseActivity<RecognizeMainActicity> implements BaseFragment.OnFragmentInteractionListener, FragmentManager.OnBackStackChangedListener {
    ...
    protected void initView() {
        Log.i(RecognizeMainActicity.class, "initView");
...
//        new DBDataRecognize(this, this).execute();
    ...
    private Fragment getFragment(Class cls, int currPage) {
        try {
            ...
            Log.e(RecognizeMainActicity.class, "getFragment Error:" + e.getMessage());
        }
        return null;
    }
    ...
    private void setInitData() {
        ...
        Log.i(RecognizeMainActicity.class, "setInit: " + initData);
        new LoadData().execute();
    ...
    private void setPageLearn(int number) {
        ...
        if (fragment != null && fragment instanceof LearnRecoginzeFragment) {
            ...
            Log.i(RecognizeMainActicity.class, "Test: " + number);
        }
        hideMenu();
    }
