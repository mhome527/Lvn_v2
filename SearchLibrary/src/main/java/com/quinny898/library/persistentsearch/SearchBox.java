...
//			lstResults.setVisibility(View.GONE);
//		} else {
//			lstResults.setVisibility(View.VISIBLE);
//		}
...
//        }
    ...
    public void showSearch() {
        ...
        RelativeLayout searchRoot = (RelativeLayout) findViewById(R.id.search_root);
        if (searchRoot.getVisibility() == View.GONE) {
